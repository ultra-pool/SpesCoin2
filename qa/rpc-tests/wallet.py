...
#   c) node1 mines 32 blocks, so now node 0 has 60001 spescoin, node 1 has 4250 spescoin, node2 has none.
#   d) node0 sends 601 spescoin to node2, in two transactions (301 spescoin, then 300 spescoin).
