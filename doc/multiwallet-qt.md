...
In order to support loading of multiple wallets in spescoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is spescoin.cpp.
...
Changes to spescoin.cpp
----------------------
spescoin.cpp is the entry point into spescoin-qt, and as such, will require some minor modifications to provide hooks for
