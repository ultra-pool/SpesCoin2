 ...
 * spescoin system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& spescoinDevKey() const { return vspescoinDevKey; }
    // const std::vector<unsigned char>& spescoinFundKey() const { return vspescoinFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vspescoinDevKey;
    // std::vector<unsigned char> vspescoinFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
