...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* spes features */
        {"spes", "masternode", &masternode, true, true, false},
        {"spes", "listmasternodes", &listmasternodes, true, true, false},
        {"spes", "getmasternodecount", &getmasternodecount, true, true, false},
        {"spes", "masternodeconnect", &masternodeconnect, true, true, false},
        {"spes", "masternodecurrent", &masternodecurrent, true, true, false},
        {"spes", "masternodedebug", &masternodedebug, true, true, false},
        {"spes", "startmasternode", &startmasternode, true, true, false},
        {"spes", "createmasternodekey", &createmasternodekey, true, true, false},
        {"spes", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"spes", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"spes", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"spes", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"spes", "getmasternodescores", &getmasternodescores, true, true, false},
        {"spes", "mnsync", &mnsync, true, true, false},
        {"spes", "spork", &spork, true, true, false},
        {"spes", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"spes", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use spescoind, or the -server option to spescoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"spes Alert\" admin@foo.com\n"),
