...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SPES Core TX utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  spescoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded spescoin transaction") + "\n" +
                               "  spescoin-tx [options] -create [commands]   " + _("Create hex-encoded spescoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded spescoin transaction
