                                              ...
                                              filter(0)
{
    ...
    ui->pushButton_Website->setStatusTip(tr("Go to SPES Website"));
    ui->pushButton_Discord->setIcon(QIcon(GUIUtil::getThemeImage(":/icons/discord")));
    ui->pushButton_Discord->setStatusTip(tr("Join SPES Discord"));
    ui->pushButton_Telegram->setIcon(QIcon(GUIUtil::getThemeImage(":/icons/telegram")));
    ui->pushButton_Telegram->setStatusTip(tr("Join SPES Telegram"));
    ui->pushButton_Twitter->setIcon(QIcon(GUIUtil::getThemeImage(":/icons/twitter")));
    ui->pushButton_Twitter->setStatusTip(tr("Join SPES Twitter"));
	ui->pushButton_Facebook->setIcon(QIcon(GUIUtil::getThemeImage(":/icons/facebook")));
    ui->pushButton_Facebook->setStatusTip(tr("Join SPES Facebook"));	
    ui->pushButton_Explorer->setIcon(QIcon(GUIUtil::getThemeImage(":/icons/explorer")));
    ui->pushButton_Explorer->setStatusTip(tr("Go to SPES Explorer"));
    ui->pushButton_Bitcointalk->setIcon(QIcon(GUIUtil::getThemeImage(":/icons/bitcointalk")));
    ui->pushButton_Bitcointalk->setStatusTip(tr("Read SPES Bitcointalk"));
    ui->pushButton_Github->setIcon(QIcon(GUIUtil::getThemeImage(":/icons/github")));
    ui->pushButton_Github->setStatusTip(tr("Go to SPES Github"));
...
void OverviewPage::on_pushButton_Discord_clicked() {
    QDesktopServices::openUrl(QUrl("https://discord.gg/TxJtH5F", QUrl::TolerantMode));
}
...
void OverviewPage::on_pushButton_Explorer_clicked() {
    QDesktopServices::openUrl(QUrl("http://178.128.164.33:5500", QUrl::TolerantMode));
}
