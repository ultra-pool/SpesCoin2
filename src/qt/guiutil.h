...
/** Utility functions used by the spescoin Qt UI.
 */
namespace GUIUtil
{
...
// Render spescoin addresses in monospace font
...
// Parse "spescoin:" URI into recipient object, return true on successful parsing
