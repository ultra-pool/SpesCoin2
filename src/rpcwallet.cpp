...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            HelpExampleCli("sendmany", "\"tabby\" \"{\\\"SkJPfpfhvxA7wdxntsxKoAywGhvcwekkwp\\\":0.01,\\\"SkJPfpfhvxA7wdxntsxKoAywGhvcwekkwp\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n" + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"SkJPfpfhvxA7wdxntsxKoAywGhvcwekkwp\\\":0.01,\\\"SkJPfpfhvxA7wdxntsxKoAywGhvcwekkwp\\\":0.02}\" 6 \"testing\"") +
            "\nAs a json rpc call\n" + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"SkJPfpfhvxA7wdxntsxKoAywGhvcwekkwp\\\":0.01,\\\"SkJPfpfhvxA7wdxntsxKoAywGhvcwekkwp\\\":0.02}\", 6, \"testing\""));
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "wallet encrypted; SPES server stopping, restart to run with encrypted wallet. The keypool has been flushed, you need to make a new backup.";
}
