...
RESOURCES += src/qt/spescoin.qrc src/qt/spescoin_locale.qrc

TRANSLATIONS += src/qt/locale/spescoin_bg.ts \
                src/qt/locale/spescoin_de.ts \
                src/qt/locale/spescoin_en.ts \
                src/qt/locale/spescoin_es.ts \
                src/qt/locale/spescoin_fi.ts \
                src/qt/locale/spescoin_fr.ts \
                src/qt/locale/spescoin_it.ts \
                src/qt/locale/spescoin_ja.ts \
                src/qt/locale/spescoin_pl.ts \
                src/qt/locale/spescoin_pt.ts \
                src/qt/locale/spescoin_ru.ts \
                src/qt/locale/spescoin_sk.ts \
                src/qt/locale/spescoin_sv.ts \
                src/qt/locale/spescoin_vi.ts \
                src/qt/locale/spescoin_zh_CN.ts \
                src/qt/locale/spescoin_zh_TW.ts
